#This repo was forked from the original and is used following the license provided by Copyright (C) 2017 Hakim El Hattab, http://hakim.se, and reveal.js contributors
